...
parser = argparse.ArgumentParser(description='Batch download pdf from sci-hub database according to DOI number')
parser.add_argument('-i', '--inputFilePath', metavar='targeExcelFile', required=True, help='Input the path to an text file')
parser.add_argument('-c', '--inputChromedriverPath', metavar='chromedriverPath', required=True, help='Specify the path to chromedriver.exe')
